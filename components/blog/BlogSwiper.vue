				...
				<div :class="itemStyle().div3">
					<div class="has-parallax-image dsn-swiper p-relative">
						<swiper-container ref="slider" init="false">
							<PostItem :data="props.data" tag="swiper-slide" :linkCircle="itemStyle().linkCircle"
								:dataParallax="itemStyle().dataParallax"
								:dataBoxContent="itemStyle().postContentParallax" />
						</swiper-container>
