...
<template>
	<div class="p-relative" :class="itemStyle().main">
		<div class="background-overlay bg-1" v-if="props.haveOverlayBG"></div>
		<slot name="title" />
		<div class="p-relative" :class="itemStyle().divStyle">
			<div class="root-posts">
				<div class="dsn-posts" :class="itemStyle().stylePost">
					<div class="has-parallax-image dsn-swiper p-relative">
						<swiper-container ref="slider" init="false" class="work" :class="props.blur ? 'has-blur' : null, itemStyle().swiperClass
							">
