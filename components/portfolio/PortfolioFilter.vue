...
const props = defineProps({ data: Array, setStyle: { type: String, default: "metro-1" }, useFilter: Boolean, filterCat: String, mode: Boolean });
const styles = [
    {
        style: "metro-1",
        main: "",
    ...
    },
    {
        ...
        bgItem: "",
        main: "",
        div1: "dsn-style-metro dsn-metro-2 box-image-transform dsn-background-inherit",
        div2: "dsn-post-type-metro grid-lg-3 dsn-isotope",
        div3: "",
        gap: "80px 30px",
        titleClass: "title-h2",
        itemClass: "",
    ...
    },
    {
        ...
        div2: "dsn-post-type-cards grid-md-2 dsn-style-cards box-image-normal v-dark-head dsn-isotope",
        div3: "",
        gap: "60px",
        itemClass: "",
    ...
    },
    {
        ...
        div2: "dsn-post-type-cards box-image-normal box-image-hover grid-md-3 dsn-masonry-grid dsn-masonry-grid-2 v-dark-head dsn-isotope",
        div3: "",
        gap: "60px",
        itemClass: "",
        titleClass: "title-h2",
    ...
    },
    {
        ...
        div2: "dsn-post-type-classic grid-md-3  dsn-masonry-grid dsn-masonry-grid-2 dsn-isotope",
        div3: "",
        gap: "60px",
        itemClass: "",
        titleClass: "title-h2",
...
function active(category) {
    ...
    iso.value.arrange({ filter: store.catName === '' ? '*' : `.${store.catName.trim().toString().toLowerCase()}` });
}
onMounted(() => {
    
    if(props.filterCat){
        store.catName = props.filterCat.trim().toString().toLowerCase()
    }
    else{
        store.catName =""
    }
...
<template>
    <div ref="iso" class="p-relative section-margin" :class="itemStyle().main">
        <div class="container">
            <slot name="title" />
        </div>
        <div class="p-relative box-image-parallax " :class="itemStyle().div1">
            <div class="root-posts has-filter">
                <div v-if="useFilter" class="dsn-filtering z-index-1 p-relative w-100 mb-50">
                    <div class="filtering-t" :class="itemStyle().filteringClass">
                ...
                <div class="dsn-posts d-grid" :class="itemStyle().div2"
