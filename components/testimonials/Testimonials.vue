...
<template>
    <div class="p-relative " :class="props.className">
        <div class="background-overlay bg-1" v-if="props.haveOverlayBG"></div>
        <div :class="props.boxStyle === 'center' ? null : 'container'">
            <slot name="title" />
            <div class=""
                :class="props.boxStyle === 'center' ? 'filter-swiper-blur image-left-style quote-box-style elementor-align-center text-center' : 'elementor-widget-dsn_testimonial'"
                    ...
                    <div class="testimonials-content">
                        <div class="testimonial-inner">
                            ...
                            <swiper-container ref="slider" init="false" class="swiper-container">
                                <swiper-slide class="swiper-slide testimonial-inner-item" :class="props.slideClass"
                                    v-for="(client, index) in props.data" :key="index">
                                    <div class="avatar box-img dsn-auto">
                                        <img :src="xUrl(client.imageSrc)" class="cover-bg-img" alt="" />
                                    </div>
                                    <div class="testimonial-item">
                                        ...
                                        <div class="content-inner border-top"
                                            :class="props.boxStyle === 'center' ? 'justify-content-center' : null">
